...
public class FirmarDocumentoService extends SignatureTest {
    ...
    public void sign(String src, String dest, int numberpage, float x, float y,
        ...
        try {
            ...
            String path = servletContext.getRealPath("imagenes") + File.separator + "Logo_ESPE.png";
            System.out.println("Path de imagen:" + path);
            ...
            appearance.setImage(ImageDataFactory.create(path));
            ...
            Logger.getLogger(FirmarDocumentoService.class.getName()).log(Level.SEVERE, null, ex);
        }

    }

    public void iniciar(String fnsrc, String fndest, String pathP12, String passP12) {
